...
- provide MIF folder path
- click **Convert**
- generate XML files in selected output folder
- generate a detailed HTML conversion log file in output folder
...
Submit the form and the browser will display the generated HTML log report directly.
